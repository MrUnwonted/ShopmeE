...
$(document).ready(function() {
    ...
    $("#navs-pills-justified-products").on("click", "#linkAddProduct", function(e) {
        e.preventDefault();
        console.log("Here")
        link = $(this);
        url = link.attr("href");
...
function generateProductCode(productId, productName, mainImagePath, productCost, productPrice, shippingCost) {
    ...
    htmlCode = `
		<div class="border rounded p-1" id="${rowId}">
			...
			<div class="row">
				<div class="col-1">
					<div class="divCount mx-1">${nextCount}</div>
					<div><a class="bx bx-trash text-dark linkRemove" href="" rowNumber="${nextCount}"></a></div>				
				</div>
				<div class="col-3">

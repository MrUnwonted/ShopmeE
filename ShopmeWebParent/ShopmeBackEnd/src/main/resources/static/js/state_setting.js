...
$(document).ready(function() {
    ...
    buttonAddState.click(function() {
        if (buttonAddState.html() == "<span class=\"tf-icons bx bx-plus\"></span>&nbsp; Add") {
            addState();
        } else {
...
function changeFormStateToNew() {
    buttonAddState.html("<span class=\"tf-icons bx bx-plus\"></span>&nbsp; Add");
...
function changeFormStateToSelectedState() {
    buttonAddState.html("<span class=\"tf-icons bx bx-plus\"></span>&nbsp; New");

...
$(document).ready(function() {
    ...
    function linkAddTrackClicked(){
        addNewTrackRecord();
    }

    $("#navs-pills-justified-track").on("click", "#linkAddTrack", function(e) {
        e.preventDefault();
        addNewTrackRecord();
    });
    ...
    htmlCode = `
			<div class="row border rounded p-1" id="${rowId}">
				...
				<div class="col-2">
					...
					<div class="mt-1"><a class="bx bx-trash bx-tada-hover text-dark linkRemoveTrack" href="" rowNumber="${nextCount}"></a></div>					
				</div>				
